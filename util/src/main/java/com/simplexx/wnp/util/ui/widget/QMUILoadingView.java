...
import com.simplexx.wnp.util.TypedValueUtil;
...
public class QMUILoadingView extends View {
    ...
    public QMUILoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSize = array.getDimensionPixelSize(R.styleable.QMUILoadingView_qmui_loading_view_size, TypedValueUtil.fromDip(32));
